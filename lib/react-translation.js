(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-translation", [], factory);
	else if(typeof exports === 'object')
		exports["react-translation"] = factory();
	else
		root["react-translation"] = factory();
...
exports.TranslationProvider = undefined;
...
var TranslationProvider = exports.TranslationProvider = function (_React$Component) {
  _inherits(TranslationProvider, _React$Component);

  function TranslationProvider(props) {
    _classCallCheck(this, TranslationProvider);

    var _this = _possibleConstructorReturn(this, (TranslationProvider.__proto__ || Object.getPrototypeOf(TranslationProvider)).call(this, props));
  ...
  _createClass(TranslationProvider, [{
    key: 'getChildContext',
    ...
    value: function translate(key) {
      var fallbackLang = 'en_US';
      if (_typeof(this.state.translation[this.state.lang]) === _typeof({}) && typeof this.state.translation[this.state.lang][key] !== 'undefined') {
        return this.state.translation[this.state.lang][key];
      } else if (_typeof(this.state.translation[fallbackLang]) === _typeof({}) && typeof this.state.translation[fallbackLang][key] !== 'undefined') {
...
TranslationProvider.propTypes = {
  translation: _propTypes2.default.object.isRequired,
  default: _propTypes2.default.string,
  children: _propTypes2.default.any
};
TranslationProvider.childContextTypes = {
  translation: _propTypes2.default.object,
...
exports.default = function (Component) {
  var Translate = function (_React$Component2) {
    _inherits(Translate, _React$Component2);
...
//# sourceMappingURL=react-translation.js.map